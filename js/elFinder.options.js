...
elFinder.prototype._options = {
	...
	cdns : {
		...
		dash       : fm.js_url+'/cdn/dash.js',
		flv        : fm.js_url+'/cdn/flv.js',
		videojs    : fm.js_url+'/cdn/videojs.js',
		prettify   : fm.js_url+'/cdn/prettify.js',
		psd        : fm.js_url+'/cdn/psd.js',
		rar        : fm.js_url+'/cdn/rar.js',
		zlibUnzip  : fm.js_url+'/cdn/zlibUnzip.js',
		// need check unzipFiles() in quicklook.plugins.js when update
		zlibGunzip : fm.js_url+'/cdn/zlibGunzip.js',
		bzip2      : fm.js_url+'/cdn/bzip2.js',
		marked     : fm.js_url+'/cdn/marked.js',
		sparkmd5   : fm.js_url+'/cdn/sparkmd5.js',
		jssha      : fm.js_url+'/cdn/jssha.js',
		amr        : fm.js_url+'/cdn/amr.js',
